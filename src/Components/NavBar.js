  ...
  <div className="container-fluid ">
    ...
    <div className="collapse navbar-collapse" id="navbarTogglerDemo03">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <Link to='/login' className="nav-link"><div><button className='login-btn'>Login</button></div>
</Link>
        </li>
        <li className="nav-item">
          <span className="nav-link"><div><button className='enrol-btn'>Enrol Now</button></div>
</span>
        </li>
      </ul>
    </div>
